# login_with_rivew_animation_5sa_26_1
...
This project was developed for the Computer Graphics course, integrating interactive vector animation with Dart programming logic.
...
A State Machine is the logical system that controls how animations change.
...
login_screen.dart → UI and Rive integration logic.

animated_login_bear.riv → Animation file with embedded State Machine.

🎬 Demo

Full interaction demo:

Email input reaction

Automatic bear movement

Password privacy animation
